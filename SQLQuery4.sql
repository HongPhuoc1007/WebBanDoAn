...
('DHMN1', 'Dua hau', 7000, 150, 'ThuHuyenFarm'),
('CS1', 'Cam sanh', 15000, 150, 'ThuHuyenFarm');
INSERT INTO ChiTietPhieuNhap (MaPhieuNhap, MaNguyenLieu, TenNguyenLieu, DonViTinh, DonGia, SoLuong, ThanhTien)
VALUES
('PN001', 'BCG1', N'Bột chiên giòn', N'Gói', 50000, 5, 250000),
('PN001', 'BCX1', N'Bột chiên xù', N'Gói', 40000, 4, 160000),
('PN001', 'GAX1', N'Gà', N'Kg', 6000, 20, 120000),
('PN001', 'KTB1', N'Khoai tây', N'Kg', 10000, 15, 150000),

('PN002', 'DCA1', N'Dưa chuột', N'Kg', 6000, 10, 60000),
('PN002', 'DHMN1', N'Dưa hấu', N'Kg', 7000, 12, 84000),
('PN002', 'CS1', N'Cam sành', N'Kg', 15000, 10, 150000);
INSERT INTO ChiTietPhieuNhap (MaPhieuNhap, MaNguyenLieu, TenNguyenLieu, DonViTinh, DonGia, SoLuong, ThanhTien)
VALUES
('PN001', 'BCG1', 'Bot chien gion', 'Goi', 50000, 5, 250000),
('PN001', 'BCX1', 'Bot chien xu', 'Goi', 40000, 4, 160000),
('PN001', 'GAX1', 'Ga', 'Kg', 6000, 20, 120000),
('PN001', 'KTB1', 'Khoai tay', 'Kg', 10000, 15, 150000),

('PN002', 'DCA1', 'Dua chuot', 'Kg', 6000, 10, 60000),
('PN002', 'DHMN1', 'Dua hau', 'Kg', 7000, 12, 84000),
('PN002', 'CS1', 'Cam sanh', 'Kg', 15000, 10, 150000);